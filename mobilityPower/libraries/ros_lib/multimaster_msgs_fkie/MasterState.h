...
namespace multimaster_msgs_fkie
{
  ...
  class MasterState : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "multimaster_msgs_fkie/MasterState"; };
    virtual const char * getMD5() override { return "80884072ff659ac99555a763e9ba0b23"; };
