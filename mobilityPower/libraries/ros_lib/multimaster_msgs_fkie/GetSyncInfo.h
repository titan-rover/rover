...
static const char GETSYNCINFO[] = "multimaster_msgs_fkie/GetSyncInfo";
  ...
  class GetSyncInfoRequest : public ros::Msg
  {
    ...
    virtual const char * getType() override { return GETSYNCINFO; };
  ...
  class GetSyncInfoResponse : public ros::Msg
  {
    ...
    GetSyncInfoResponse():
      hosts_length(0), st_hosts(), hosts(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return GETSYNCINFO; };
    virtual const char * getMD5() override { return "d5261ec56e202860a07fb47b41e1b2a8"; };
