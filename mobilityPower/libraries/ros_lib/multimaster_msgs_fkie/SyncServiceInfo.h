...
namespace multimaster_msgs_fkie
{
  ...
  class SyncServiceInfo : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "multimaster_msgs_fkie/SyncServiceInfo"; };
    virtual const char * getMD5() override { return "8c21bb9ea24403924441840b8c167c40"; };
