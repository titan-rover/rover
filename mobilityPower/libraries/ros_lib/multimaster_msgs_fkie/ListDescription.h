...
static const char LISTDESCRIPTION[] = "multimaster_msgs_fkie/ListDescription";
  ...
  class ListDescriptionRequest : public ros::Msg
  {
    ...
    virtual const char * getType() override { return LISTDESCRIPTION; };
  ...
  class ListDescriptionResponse : public ros::Msg
  {
    ...
    ListDescriptionResponse():
      robot_name(""),
      robot_type(""),
      robot_images_length(0), st_robot_images(), robot_images(nullptr),
      robot_descr(""),
      capabilities_length(0), st_capabilities(), capabilities(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return LISTDESCRIPTION; };
    virtual const char * getMD5() override { return "a36ba5a97ce785b9b964aa015b26332b"; };
