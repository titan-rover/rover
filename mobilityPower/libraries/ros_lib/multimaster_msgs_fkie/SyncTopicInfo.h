...
namespace multimaster_msgs_fkie
{
  ...
  class SyncTopicInfo : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "multimaster_msgs_fkie/SyncTopicInfo"; };
    virtual const char * getMD5() override { return "1b296160d6f5a9d7f6550f6130da2ba4"; };
