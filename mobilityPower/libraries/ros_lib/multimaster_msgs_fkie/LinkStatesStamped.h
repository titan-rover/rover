...
namespace multimaster_msgs_fkie
{
  ...
  class LinkStatesStamped : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "multimaster_msgs_fkie/LinkStatesStamped"; };
    virtual const char * getMD5() override { return "b7c41a46488485ec6593097b0cabe904"; };
