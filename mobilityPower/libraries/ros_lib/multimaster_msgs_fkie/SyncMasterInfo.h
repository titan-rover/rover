...
namespace multimaster_msgs_fkie
{
  ...
  class SyncMasterInfo : public ros::Msg
  {
    ...
    SyncMasterInfo():
      ...
      publisher_length(0), st_publisher(), publisher(nullptr),
      subscriber_length(0), st_subscriber(), subscriber(nullptr),
    ...
    virtual const char * getType() override { return "multimaster_msgs_fkie/SyncMasterInfo"; };
    virtual const char * getMD5() override { return "ba4b02792114bcc4bae507c60dd14d66"; };
